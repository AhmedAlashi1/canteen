                                ...
                                <div class="col-md-12 col-12">
                                    <div class="form-group">
                                        ...
                                        <select
                                            ...
                                            required
                                        >
                                            <option value="1" {{ old('status', $child->status ?? '') == 'active' ? 'selected' : '' }}>{{ __('general.Active') }}</option>
                                            <option value="2" {{ old('status', $child->status ?? '') == 'pending_approval' ? 'selected' : '' }}>{{ __('general.Pending') }}</option>
                                            <option value="0" {{ old('status', $child->status ?? '') == 'inactive' ? 'selected' : '' }}>{{ __('general.Inactive') }}</option>
                                        </select>
                                        @error('status')
