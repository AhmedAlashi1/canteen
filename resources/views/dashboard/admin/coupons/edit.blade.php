                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input
                                            ...
                                            value="{{ old('use_number', $coupon->use_number) }}"
                                            required
                                        />
                                        @error('use_number')
                                        <span class="col-form-label-sm text-danger">{{ $message }}</span>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input
                                            ...
                                            value="{{ old('end_at', \Carbon\Carbon::parse($coupon->end_at)->format('Y-m-d')) }}"
                                            required
                                        />
                                        @error('end_at')
                                        <span class="col-form-label-sm text-danger">{{ $message }}</span>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <select
                                            ...
                                            required
                                        >
                                            <option value="active" {{ old('status', $coupon->status) == 'active' ? 'selected' : '' }}>{{ __('general.Active') }}</option>
                                            <option value="inactive" {{ old('status', $coupon->status) == 'inactive' ? 'selected' : '' }}>{{ __('general.Inactive') }}</option>
                                        </select>
                                        @error('status')
                                        <span class="col-form-label-sm text-danger">{{ $message }}</span>
                                        @enderror
